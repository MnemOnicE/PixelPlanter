...
Game developers rarely need _one_ rock; they need _five_ variations of a rock to paint a level. The **Asset Factory** shifts the focus from "generating an image" to "generating a set."
